...
public class Ability : MonoBehaviour
{
    public struct BuffDebuff
    {
        ...
        public int physicalDefenseMod;
        public int physicalAttackMod;
        public int magicalDefenseMod;
        public int magicalAttackMod;
        public int pureDefenseMod;
        public int pureAttackMod;
    ...
    public struct AbilityStruct
    {
        ...
        public Enumerations.TargetPoint targetPoint; //CastType
        public List<int[]> tilesInAOE;
